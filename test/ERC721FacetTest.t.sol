...
contract ERC721FacetTest is Test {
    ...
    function setUp() public {
        ...
        selectors[1]  = ERC721Facet.name.selector;
        selectors[2]  = ERC721Facet.symbol.selector;
        selectors[3]  = ERC721Facet.tokenURI.selector;
        selectors[4]  = ERC721Facet.balanceOf.selector;
        selectors[5]  = ERC721Facet.ownerOf.selector;
        selectors[6]  = ERC721Facet.approve.selector;
...
function test_InitName() public {
        assertEq(tokenFull.name(), "TestNFT");
    }

    function test_InitSymbol() public  {
        assertEq(tokenFull.symbol(), "TNFT");
    }
